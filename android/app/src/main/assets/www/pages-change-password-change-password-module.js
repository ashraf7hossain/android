...
let CoreLoginChangePasswordPage = class CoreLoginChangePasswordPage {
    ...
    detectPasswordChanged() {
        ...
        this.urlLoadedObserver = _singletons_events__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].on(_singletons_events__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].IAB_LOAD_STOP, (event) => {
            var _a;
            ...
            (_a = _services_utils_utils__WEBPACK_IMPORTED_MODULE_8__["CoreUtils"].getInAppBrowserInstance()) === null || _a === void 0 ? void 0 : _a.executeScript({
                code: `
                    if (
        ...
        this.messageObserver = _singletons_events__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].on(_singletons_events__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].IAB_MESSAGE, (data) => {
